...
public class SelectLevel : MonoBehaviour {
	...
	void FillGrid() {
		...
		Debug.Log("level::" + GameManager.currentPack + ",count=" + GameManager.maxLevels +",packs="+GameManager.maxPacks);
		GameObject panel = GameObject.Find ("Buttons-Panel");
		for (int i = 0; i < GameManager.maxLevels; i++) {
	...
	void LoadLevel(int level) {
		...
		SceneManager.LoadScene ("LP" + GameManager.currentPack + "_" + "level-" + level,LoadSceneMode.Single);
	}
}
