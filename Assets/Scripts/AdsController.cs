...
public class AdsController : MonoBehaviour {
	...
	#if ADMOB
	private string AndroidBannerID = "ANDROID_BANNER_ID";
	private string AndroidInterstitialID = "ANDROID_INTERSTITIALS_ID";
	private string AndroidRewardedVideoID = "ANDROID_REWARDED_VIDEO_ID";
